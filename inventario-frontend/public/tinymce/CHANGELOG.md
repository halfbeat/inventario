...
- Ctrl+Shift+HomePage/End or Cmd+Shift+Up-arrow/Down-arrow did not expand the selection to a `contenteditable="false"` element if the element was at the beginning or end of a document. #TINY-7795
...
- Fixed sub-menu items not read by screen readers. Patch contributed by westonkd. #TINY-8417
- The HomePage or End keys would move out of a editable element contained within a noneditable element. #TINY-8201
...
- Fixed an issue where **HomePage/End** keys wouldn't move the caret correctly before or after `contenteditable=false` inline elements. #TINY-2995
