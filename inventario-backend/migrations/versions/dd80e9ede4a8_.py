...
Revision ID: dd80e9ede4a8
Revises: 
Create Date: 2025-03-21 13:24:23.860297
...
def upgrade():
    ...
    op.create_table('INVEGSS_APLICACIONES',
    ...
    op.create_table('INVESGSS_COMPONENTES',
                    ...
                    sa.ForeignKeyConstraint(['C_SISINFO_ID', 'C_COMPONENTE_PADRE_ID'],
                                            ['INVESGSS_COMPONENTES.C_SISINFO_ID',
                                             'INVESGSS_COMPONENTES.C_COMPONENTE_ID'], ),
                    sa.ForeignKeyConstraint(['C_SISINFO_ID'], ['INVEGSS_APLICACIONES.C_SISINFO_ID'], ),
    ...
    op.create_table('INVESGSS_EMPRESAS_COMPONENTES',
                    ...
                    sa.Column('C_ROL_ID',
                              sa.Enum('JEFE_DE_PROYECTO', 'ANALISTA', 'DESARROLLADOR', name='rolasignacionenum'),
                              nullable=False),
...
def downgrade():
    ...
    op.drop_table('INVEGSS_APLICACIONES')
